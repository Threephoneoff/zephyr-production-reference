...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_ZEPHYR_LOGGER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_ZEPHYR_LOGGER_STM32H7B3XX, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_STM32H7B3XXQ, 1);
